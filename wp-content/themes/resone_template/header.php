...
<div id="page" class="site"><!-- start-page -->
	...
	<header id="masthead" class="site-header">
		<?php $add_phone_callout    = get_field( 'add_a_contact_phone_number', option );
					$add_download_callout = get_field( 'add_a_download_application', option ); ?>
				...
				<?php if( $add_download_callout == 'Yes' || $add_phone_callout == 'Yes' ): ?>
					...
					<div id="masthead-tel">
						...
						<?php if ( $add_phone_callout == 'Yes' ):
							...
							$callout_text = get_field( 'phone_callout_text', option ); ?>

							<a class="tel-link" href="tel:<?php echo esc_html( $ph ) ?>"><span><svg xmlns="http://www.w3.org/2000/svg" width="30" height="30" viewBox="0 0 30 30"><title>icon-phone</title><path fill="#d0a449" d="M28.3 2.3a.5.5 0 0 0-.7.7 4.8 4.8 0 0 1 0 6.77.5.5 0 0 0 .7.73 5.8 5.8 0 0 0 0-8.17m-2.1 1.1a.5.5 0 0 0-.7.7 3.28 3.28 0 0 1 0 4.65.5.5 0 0 0 .68.73 4.3 4.3 0 0 0 0-6.04M2.4 3a.5.5 0 1 0-.7-.7 5.8 5.8 0 0 0 0 8.2.5.5 0 0 0 .7-.73A4.8 4.8 0 0 1 2.4 3m2.12.3a.5.5 0 0 0-.7 0 4.3 4.3 0 0 0 0 6 .5.5 0 0 0 .72-.7A3.3 3.3 0 0 1 4.5 4a.5.5 0 0 0 0-.7M16 26.5a1 1 0 1 1-1-1 1 1 0 0 1 1 1m6.5-3.5h-15V4h15zM15 28.5a2 2 0 1 1 2-2 2 2 0 0 1-2 2m-2-27h2a.5.5 0 0 1 0 1h-2a.5.5 0 0 1 0-1m3.5 0h.5a.5.5 0 0 1 0 1h-.5a.5.5 0 0 1 0-1M21.3 0H8.7a2.2 2.2 0 0 0-2.2 2.2v25.6A2.2 2.2 0 0 0 8.7 30h12.6a2.2 2.2 0 0 0 2.2-2.2V2.2A2.2 2.2 0 0 0 21.3 0"/></svg></span><span class="call"><?php echo esc_html( $callout_text ); ?></span><span class="tel"><?php echo esc_html( $ph ); ?></span></a>
